...
#SBATCH --array=0-2
#SBATCH --output="/home/chidamv/scratch/logs/smacv2/%x-%A_%a.out"
#SBATCH --error="/home/chidamv/scratch/logs/smacv2/%x-%A_%a.err"
...
ENV_CONFIG=${1:-"sc2_v2_protoss_10v10"}
