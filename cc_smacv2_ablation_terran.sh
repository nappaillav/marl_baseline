...
# GPU jobs (MIG h100_1g.10gb via cc_smacv2_gpu_ablation_runs.sh), t_max=5005000, 11:59:00 wall per job.
...
jobScript="/home/zwang182/MARL/marl_p3_smacv2/cc_smacv2_gpu_ablation_runs.sh"   # study-specific copy of cc_smacv2_gpu.sh
