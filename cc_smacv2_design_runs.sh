...
jobScript="/home/zwang182/MARL/marl_p3/marl_p3_smacv2/cc_smacv2_cpu_ablation_runs.sh"   # study-specific copy of cc_smacv2_cpu.sh (10th arg = save_model_interval)
